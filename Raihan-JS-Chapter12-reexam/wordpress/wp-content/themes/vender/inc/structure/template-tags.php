			...
			<section class="storefront-product-section storefront-product-categories">
				...
				<?php
					...
					<?php endif; ?>
						...
						<a href="<?php echo get_term_link( $product_category ); ?>"></a>
					</li>
...
if ( ! function_exists( 'storefront_recent_products' ) ) {
	...
	function storefront_recent_products( $args ) {
		...
		if ( is_woocommerce_activated() ) {
			...
			echo '<section class="storefront-product-section storefront-recent-products"><div class="col-full">';
...
if ( ! function_exists( 'storefront_best_selling_products' ) ) {
	...
	function storefront_best_selling_products( $args ) {
		if ( is_woocommerce_activated() ) {
			...
			echo '<section class="storefront-product-section storefront-best-selling-products"><div class="col-full">';
...
if ( ! function_exists( 'storefront_featured_products' ) ) {
	...
	function storefront_featured_products( $args ) {
		...
		if ( is_woocommerce_activated() ) {
			...
			echo '<section class="storefront-product-section storefront-featured-products"><div class="col-full">';
...
if ( ! function_exists( 'storefront_popular_products' ) ) {
	...
	function storefront_popular_products( $args ) {
		...
		if ( is_woocommerce_activated() ) {
			...
			echo '<section class="storefront-product-section storefront-popular-products"><div class="col-full">';
...
if ( ! function_exists( 'storefront_on_sale_products' ) ) {
	...
	function storefront_on_sale_products( $args ) {
		...
		if ( is_woocommerce_activated() ) {
			...
			echo '<section class="storefront-product-section storefront-on-sale-products"><div class="col-full">';
...
if ( ! function_exists( 'storefront_homepage_content' ) ) {
	...
	function storefront_homepage_content() {
		while ( have_posts() ) : the_post(); ?>
			...
			?>
			<div class="home-page-content" <?php if(has_post_thumbnail()){ ?> style="background-image:url(<?php echo $thumb_url; ?>);" <?php } ?> >
			<div class="col-full">
